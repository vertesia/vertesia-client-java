...
public class RunCreatePayload {
    ...
    public RunCreatePayload resultSchema(
    ...
    public RunCreatePayload addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public RunCreatePayload addToolDefinitionsItem(ToolDefinition toolDefinitionsItem) {
    ...
    public RunCreatePayload addPromptsItem(InCodePrompt promptsItem) {
    ...
    public boolean equals(Object o) {
        ...
        RunCreatePayload runCreatePayload = (RunCreatePayload) o;
        return Objects.equals(this.data, runCreatePayload.data)
                && Objects.equals(this.config, runCreatePayload.config)
                && Objects.equals(this.resultSchema, runCreatePayload.resultSchema)
                && Objects.equals(this.stream, runCreatePayload.stream)
                && Objects.equals(this.doValidate, runCreatePayload.doValidate)
                && Objects.equals(this.tags, runCreatePayload.tags)
                && Objects.equals(this.conversation, runCreatePayload.conversation)
                && Objects.equals(this.toolDefinitions, runCreatePayload.toolDefinitions)
                && Objects.equals(this.workflow, runCreatePayload.workflow)
                && Objects.equals(this.prompts, runCreatePayload.prompts)
                && Objects.equals(this.asyncCompletion, runCreatePayload.asyncCompletion)
                && Objects.equals(this.interaction, runCreatePayload.interaction);
    }
    ...
    public String toString() {
        ...
        sb.append("class RunCreatePayload {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to RunCreatePayload
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RunCreatePayload.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in RunCreatePayload is not found in the empty JSON string",
                                RunCreatePayload.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : RunCreatePayload.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!RunCreatePayload.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'RunCreatePayload' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<RunCreatePayload> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(RunCreatePayload.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<RunCreatePayload>() {
                        @Override
                        public void write(JsonWriter out, RunCreatePayload value)
                                throws IOException {
                        ...
                        @Override
                        public RunCreatePayload read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of RunCreatePayload given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of RunCreatePayload
     * @throws IOException if the JSON string is invalid with respect to RunCreatePayload
     */
    public static RunCreatePayload fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, RunCreatePayload.class);
    }

    /**
     * Convert an instance of RunCreatePayload to an JSON string
     *
     * @return JSON string
     */
