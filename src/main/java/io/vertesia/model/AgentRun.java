...
public class AgentRun {
    ...
    public AgentRun putDataItem(String key, Object dataItem) {
        if (this.data == null) {
    ...
    public AgentRun addToolNamesItem(String toolNamesItem) {
    ...
    public AgentRun addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public AgentRun addCategoriesItem(String categoriesItem) {
    ...
    public AgentRun putPropertiesItem(String key, Object propertiesItem) {
    ...
    public AgentRun addLessonsLearnedItem(String lessonsLearnedItem) {
    ...
    public AgentRun feedback(@jakarta.annotation.Nullable List<AgentRunFeedbackEntry> feedback) {
        this.feedback = feedback;
        return this;
    }

    public AgentRun addFeedbackItem(AgentRunFeedbackEntry feedbackItem) {
     ...
     * @return the AgentRun instance itself
     */
    public AgentRun putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        AgentRun agentRun = (AgentRun) o;
        return Objects.equals(this.interaction, agentRun.interaction)
                ...
                && Objects.equals(this.categories, agentRun.categories)
                && Objects.equals(this.properties, agentRun.properties)
                && Objects.equals(this.source, agentRun.source)
                && Objects.equals(this.scheduleId, agentRun.scheduleId)
                && Objects.equals(this.sourceType, agentRun.sourceType)
                ...
                && Objects.equals(this.workflowId, agentRun.workflowId)
                && Objects.equals(this.firstWorkflowRunId, agentRun.firstWorkflowRunId)
                && Objects.equals(this.artifactsPath, agentRun.artifactsPath)
                && Objects.equals(this.status, agentRun.status)
                && Objects.equals(this.activityState, agentRun.activityState)
                && Objects.equals(this.startedBy, agentRun.startedBy)
                ...
                && Objects.equals(this.lastArchiveError, agentRun.lastArchiveError)
                && Objects.equals(this.forkedFrom, agentRun.forkedFrom)
                && Objects.equals(this.additionalProperties, agentRun.additionalProperties);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AgentRun
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AgentRun.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in AgentRun is not found in the empty JSON string",
                                AgentRun.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : AgentRun.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AgentRun.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AgentRun' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AgentRun> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(AgentRun.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AgentRun>() {
                        @Override
                        public void write(JsonWriter out, AgentRun value) throws IOException {
                        ...
                        @Override
                        public AgentRun read(JsonReader in) throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            AgentRun instance = thisAdapter.fromJsonTree(jsonObj);
    ...
    /**
     * Create an instance of AgentRun given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AgentRun
     * @throws IOException if the JSON string is invalid with respect to AgentRun
     */
    public static AgentRun fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AgentRun.class);
    }

    /**
     * Convert an instance of AgentRun to an JSON string
     *
     * @return JSON string
     */
