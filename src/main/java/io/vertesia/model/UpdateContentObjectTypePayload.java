...
public class UpdateContentObjectTypePayload {
    ...
    public UpdateContentObjectTypePayload status(
    ...
    public UpdateContentObjectTypePayload isChunkable(
    ...
    public UpdateContentObjectTypePayload intake(
    ...
    public UpdateContentObjectTypePayload editing(
    ...
    public UpdateContentObjectTypePayload tableLayout(
            @jakarta.annotation.Nullable List<ColumnLayout> tableLayout) {
        this.tableLayout = tableLayout;
        return this;
    }

    public UpdateContentObjectTypePayload addTableLayoutItem(ColumnLayout tableLayoutItem) {
    ...
    public UpdateContentObjectTypePayload objectSchema(
            @jakarta.annotation.Nullable Map<String, Object> objectSchema) {
        this.objectSchema = objectSchema;
        return this;
    }

    public UpdateContentObjectTypePayload putObjectSchemaItem(String key, Object objectSchemaItem) {
    ...
    public UpdateContentObjectTypePayload strictMode(
    ...
    public UpdateContentObjectTypePayload name(@jakarta.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateContentObjectTypePayload description(
    ...
    public UpdateContentObjectTypePayload tags(@jakarta.annotation.Nullable List<String> tags) {
        this.tags = tags;
        return this;
    }

    public UpdateContentObjectTypePayload addTagsItem(String tagsItem) {
        if (this.tags == null) {
     ...
     * @return the UpdateContentObjectTypePayload instance itself
     */
    public UpdateContentObjectTypePayload putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateContentObjectTypePayload updateContentObjectTypePayload =
                (UpdateContentObjectTypePayload) o;
        return Objects.equals(this.status, updateContentObjectTypePayload.status)
                && Objects.equals(this.isChunkable, updateContentObjectTypePayload.isChunkable)
                && Objects.equals(this.intake, updateContentObjectTypePayload.intake)
                && Objects.equals(this.editing, updateContentObjectTypePayload.editing)
                && Objects.equals(this.tableLayout, updateContentObjectTypePayload.tableLayout)
                && Objects.equals(this.objectSchema, updateContentObjectTypePayload.objectSchema)
                && Objects.equals(this.strictMode, updateContentObjectTypePayload.strictMode)
                && Objects.equals(this.name, updateContentObjectTypePayload.name)
    ...
    public String toString() {
        ...
        sb.append("class UpdateContentObjectTypePayload {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to UpdateContentObjectTypePayload
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateContentObjectTypePayload.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in UpdateContentObjectTypePayload is not found in the empty JSON string",
                                UpdateContentObjectTypePayload.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateContentObjectTypePayload.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateContentObjectTypePayload' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<UpdateContentObjectTypePayload> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(UpdateContentObjectTypePayload.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateContentObjectTypePayload>() {
                        @Override
                        public void write(JsonWriter out, UpdateContentObjectTypePayload value)
                                throws IOException {
                        ...
                        @Override
                        public UpdateContentObjectTypePayload read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            UpdateContentObjectTypePayload instance =
    ...
    /**
     * Create an instance of UpdateContentObjectTypePayload given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of UpdateContentObjectTypePayload
     * @throws IOException if the JSON string is invalid with respect to UpdateContentObjectTypePayload
     */
    public static UpdateContentObjectTypePayload fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, UpdateContentObjectTypePayload.class);
    }

    /**
     * Convert an instance of UpdateContentObjectTypePayload to an JSON string
     *
     * @return JSON string
     */
