...
public class OAuthClientCreateResponse {
    ...
    public OAuthClientCreateResponse addRedirectUrisItem(String redirectUrisItem) {
    ...
    public OAuthClientCreateResponse addGrantTypesItem(OAuthGrantType grantTypesItem) {
    ...
    public OAuthClientCreateResponse addResponseTypesItem(OAuthResponseType responseTypesItem) {
    ...
    public OAuthClientCreateResponse addAllowedScopesItem(String allowedScopesItem) {
    ...
    public OAuthClientCreateResponse addDefaultScopesItem(String defaultScopesItem) {
    ...
    public OAuthClientCreateResponse putMetadataItem(String key, Object metadataItem) {
     ...
     * @return the OAuthClientCreateResponse instance itself
     */
    public OAuthClientCreateResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        OAuthClientCreateResponse oauthClientCreateResponse = (OAuthClientCreateResponse) o;
        return Objects.equals(this.clientName, oauthClientCreateResponse.clientName)
                && Objects.equals(this.clientType, oauthClientCreateResponse.clientType)
                && Objects.equals(this.redirectUris, oauthClientCreateResponse.redirectUris)
                && Objects.equals(this.grantTypes, oauthClientCreateResponse.grantTypes)
                && Objects.equals(this.responseTypes, oauthClientCreateResponse.responseTypes)
                && Objects.equals(
                        this.tokenEndpointAuthMethod,
                        oauthClientCreateResponse.tokenEndpointAuthMethod)
                && Objects.equals(this.allowedScopes, oauthClientCreateResponse.allowedScopes)
                && Objects.equals(this.defaultScopes, oauthClientCreateResponse.defaultScopes)
                && Objects.equals(
                        this.registrationSource, oauthClientCreateResponse.registrationSource)
                && Objects.equals(this.status, oauthClientCreateResponse.status)
                && Objects.equals(
                ...
                && Objects.equals(
                        this.clientSecretConfigured,
                        oauthClientCreateResponse.clientSecretConfigured)
                && Objects.equals(this.createdAt, oauthClientCreateResponse.createdAt)
                && Objects.equals(this.updatedAt, oauthClientCreateResponse.updatedAt)
                && Objects.equals(this.clientId, oauthClientCreateResponse.clientId)
                && Objects.equals(this.clientSecret, oauthClientCreateResponse.clientSecret)
                && Objects.equals(
                        this.additionalProperties, oauthClientCreateResponse.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("class OAuthClientCreateResponse {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to OAuthClientCreateResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OAuthClientCreateResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in OAuthClientCreateResponse is not found in the empty JSON string",
                                OAuthClientCreateResponse.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : OAuthClientCreateResponse.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OAuthClientCreateResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OAuthClientCreateResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OAuthClientCreateResponse> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(OAuthClientCreateResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OAuthClientCreateResponse>() {
                        @Override
                        public void write(JsonWriter out, OAuthClientCreateResponse value)
                                throws IOException {
                        ...
                        @Override
                        public OAuthClientCreateResponse read(JsonReader in) throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            OAuthClientCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
    ...
    /**
     * Create an instance of OAuthClientCreateResponse given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of OAuthClientCreateResponse
     * @throws IOException if the JSON string is invalid with respect to OAuthClientCreateResponse
     */
    public static OAuthClientCreateResponse fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, OAuthClientCreateResponse.class);
    }

    /**
     * Convert an instance of OAuthClientCreateResponse to an JSON string
     *
     * @return JSON string
     */
