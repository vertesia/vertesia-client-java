...
public class ExecutionEnvironmentSettings {
     ...
     * @return the ExecutionEnvironmentSettings instance itself
     */
    public ExecutionEnvironmentSettings putAdditionalProperty(String key, Object value) {
     ...
     * @throws IOException if the JSON Element is invalid with respect to ExecutionEnvironmentSettings
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExecutionEnvironmentSettings.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in ExecutionEnvironmentSettings is not found in the empty JSON string",
                                ExecutionEnvironmentSettings.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExecutionEnvironmentSettings.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExecutionEnvironmentSettings' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ExecutionEnvironmentSettings> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ExecutionEnvironmentSettings.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ExecutionEnvironmentSettings>() {
                        @Override
                        public void write(JsonWriter out, ExecutionEnvironmentSettings value)
                                throws IOException {
                        ...
                        @Override
                        public ExecutionEnvironmentSettings read(JsonReader in) throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            ExecutionEnvironmentSettings instance =
    ...
    /**
     * Create an instance of ExecutionEnvironmentSettings given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ExecutionEnvironmentSettings
     * @throws IOException if the JSON string is invalid with respect to ExecutionEnvironmentSettings
     */
    public static ExecutionEnvironmentSettings fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ExecutionEnvironmentSettings.class);
    }

    /**
     * Convert an instance of ExecutionEnvironmentSettings to an JSON string
     *
     * @return JSON string
     */
