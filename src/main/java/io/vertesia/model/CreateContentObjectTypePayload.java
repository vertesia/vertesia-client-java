...
public class CreateContentObjectTypePayload {
    ...
    public CreateContentObjectTypePayload editing(
    ...
    public CreateContentObjectTypePayload addTableLayoutItem(ColumnLayout tableLayoutItem) {
    ...
    public CreateContentObjectTypePayload objectSchema(
            @jakarta.annotation.Nullable Map<String, Object> objectSchema) {
        this.objectSchema = objectSchema;
        return this;
    }

    public CreateContentObjectTypePayload putObjectSchemaItem(String key, Object objectSchemaItem) {
    ...
    public CreateContentObjectTypePayload strictMode(
    ...
    public CreateContentObjectTypePayload name(@jakarta.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateContentObjectTypePayload description(
    ...
    public CreateContentObjectTypePayload tags(@jakarta.annotation.Nullable List<String> tags) {
        this.tags = tags;
        return this;
    }

    public CreateContentObjectTypePayload addTagsItem(String tagsItem) {
        if (this.tags == null) {
     ...
     * @return the CreateContentObjectTypePayload instance itself
     */
    public CreateContentObjectTypePayload putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.status, createContentObjectTypePayload.status)
                ...
                && Objects.equals(this.editing, createContentObjectTypePayload.editing)
                ...
                && Objects.equals(this.name, createContentObjectTypePayload.name)
                && Objects.equals(this.description, createContentObjectTypePayload.description)
                && Objects.equals(this.tags, createContentObjectTypePayload.tags)
                && Objects.equals(
                        this.additionalProperties,
                        createContentObjectTypePayload.additionalProperties);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateContentObjectTypePayload
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateContentObjectTypePayload.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in CreateContentObjectTypePayload is not found in the empty JSON string",
                                CreateContentObjectTypePayload.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : CreateContentObjectTypePayload.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateContentObjectTypePayload.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateContentObjectTypePayload' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateContentObjectTypePayload> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateContentObjectTypePayload.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateContentObjectTypePayload>() {
                        @Override
                        public void write(JsonWriter out, CreateContentObjectTypePayload value)
                                throws IOException {
                        ...
                        @Override
                        public CreateContentObjectTypePayload read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            CreateContentObjectTypePayload instance =
    ...
    /**
     * Create an instance of CreateContentObjectTypePayload given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateContentObjectTypePayload
     * @throws IOException if the JSON string is invalid with respect to CreateContentObjectTypePayload
     */
    public static CreateContentObjectTypePayload fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateContentObjectTypePayload.class);
    }

    /**
     * Convert an instance of CreateContentObjectTypePayload to an JSON string
     *
     * @return JSON string
     */
