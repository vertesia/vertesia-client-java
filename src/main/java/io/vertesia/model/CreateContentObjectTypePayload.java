...
public class CreateContentObjectTypePayload {
    ...
    public CreateContentObjectTypePayload strictMode(
            @javax.annotation.Nullable Boolean strictMode) {
    ...
    public CreateContentObjectTypePayload name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateContentObjectTypePayload tags(@javax.annotation.Nullable List<String> tags) {
        this.tags = tags;
        return this;
    }
