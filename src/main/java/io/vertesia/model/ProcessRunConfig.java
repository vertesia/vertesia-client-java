...
public class ProcessRunConfig {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.model, processRunConfig.model)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(model, userMessage, processWorkstreamMonitor, additionalProperties);
    }
    ...
    static {
        ...
        openapiFields =
                new HashSet<String>(
                        Arrays.asList("model", "user_message", "process_workstream_monitor"));
