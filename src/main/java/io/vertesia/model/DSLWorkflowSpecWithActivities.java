...
public class DSLWorkflowSpecWithActivities {
    ...
    public DSLWorkflowSpecWithActivities() {}

    public DSLWorkflowSpecWithActivities name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public DSLWorkflowSpecWithActivities description(
    ...
    public DSLWorkflowSpecWithActivities tags(@javax.annotation.Nullable List<String> tags) {
        this.tags = tags;
        return this;
    }

    public DSLWorkflowSpecWithActivities addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public DSLWorkflowSpecWithActivities steps(
            @javax.annotation.Nullable List<DSLWorkflowStep> steps) {
        this.steps = steps;
        return this;
    }
    ...
    public DSLWorkflowSpecWithActivities activities(
            @javax.annotation.Nonnull List<DSLActivitySpec> activities) {
    ...
    @Deprecated
    public void setActivities(@javax.annotation.Nonnull List<DSLActivitySpec> activities) {
        this.activities = activities;
    }

    public DSLWorkflowSpecWithActivities vars(@javax.annotation.Nonnull Map<String, Object> vars) {
        this.vars = vars;
        return this;
    }

    public DSLWorkflowSpecWithActivities putVarsItem(String key, Object varsItem) {
        if (this.vars == null) {
    ...
    public DSLWorkflowSpecWithActivities options(
            @javax.annotation.Nullable DSLActivityOptions options) {
    ...
    public DSLWorkflowSpecWithActivities result(@javax.annotation.Nullable String result) {
        this.result = result;
        return this;
    }
    ...
    public DSLWorkflowSpecWithActivities debugMode(@javax.annotation.Nullable Boolean debugMode) {
     ...
     * @return the DSLWorkflowSpecWithActivities instance itself
     */
    public DSLWorkflowSpecWithActivities putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        DSLWorkflowSpecWithActivities dsLWorkflowSpecWithActivities =
                (DSLWorkflowSpecWithActivities) o;
        return Objects.equals(this.name, dsLWorkflowSpecWithActivities.name)
                ...
                && Objects.equals(
                        ...
                        dsLWorkflowSpecWithActivities.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("class DSLWorkflowSpecWithActivities {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to DSLWorkflowSpecWithActivities
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DSLWorkflowSpecWithActivities.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in DSLWorkflowSpecWithActivities is not found in the empty JSON string",
                                DSLWorkflowSpecWithActivities.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : DSLWorkflowSpecWithActivities.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DSLWorkflowSpecWithActivities.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DSLWorkflowSpecWithActivities' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DSLWorkflowSpecWithActivities> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(DSLWorkflowSpecWithActivities.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DSLWorkflowSpecWithActivities>() {
                        @Override
                        public void write(JsonWriter out, DSLWorkflowSpecWithActivities value)
                                throws IOException {
                        ...
                        @Override
                        public DSLWorkflowSpecWithActivities read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            DSLWorkflowSpecWithActivities instance =
    ...
    /**
     * Create an instance of DSLWorkflowSpecWithActivities given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of DSLWorkflowSpecWithActivities
     * @throws IOException if the JSON string is invalid with respect to DSLWorkflowSpecWithActivities
     */
    public static DSLWorkflowSpecWithActivities fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, DSLWorkflowSpecWithActivities.class);
    }

    /**
     * Convert an instance of DSLWorkflowSpecWithActivities to an JSON string
     *
     * @return JSON string
     */
