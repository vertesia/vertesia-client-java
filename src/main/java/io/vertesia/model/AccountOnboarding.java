...
public class AccountOnboarding {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.completed, accountOnboarding.completed)
                && Objects.equals(this.completedAt, accountOnboarding.completedAt);
    }

    @Override
    public int hashCode() {
        return Objects.hash(completed, completedAt);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AccountOnboarding
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AccountOnboarding.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in AccountOnboarding is not found in the empty JSON string",
                                AccountOnboarding.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<AccountOnboarding>() {
                        @Override
                        public void write(JsonWriter out, AccountOnboarding value)
                                throws IOException {
