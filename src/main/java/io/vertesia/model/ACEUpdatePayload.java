...
public class ACEUpdatePayload {
    ...
    public ACEUpdatePayload addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public boolean equals(Object o) {
        ...
        ACEUpdatePayload acEUpdatePayload = (ACEUpdatePayload) o;
        return Objects.equals(this.role, acEUpdatePayload.role)
                && Objects.equals(this.resourceType, acEUpdatePayload.resourceType)
                && Objects.equals(this.resource, acEUpdatePayload.resource)
                && Objects.equals(this.principalType, acEUpdatePayload.principalType)
                && Objects.equals(this.principal, acEUpdatePayload.principal)
                && Objects.equals(this.account, acEUpdatePayload.account)
                && Objects.equals(this.project, acEUpdatePayload.project)
                && Objects.equals(this.conditions, acEUpdatePayload.conditions)
                && Objects.equals(this.tags, acEUpdatePayload.tags)
                && Objects.equals(this.expiresAt, acEUpdatePayload.expiresAt);
    }
    ...
    public String toString() {
        ...
        sb.append("class ACEUpdatePayload {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to ACEUpdatePayload
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ACEUpdatePayload.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in ACEUpdatePayload is not found in the empty JSON string",
                                ACEUpdatePayload.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ACEUpdatePayload.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ACEUpdatePayload' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ACEUpdatePayload> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(ACEUpdatePayload.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ACEUpdatePayload>() {
                        @Override
                        public void write(JsonWriter out, ACEUpdatePayload value)
                                throws IOException {
                        ...
                        @Override
                        public ACEUpdatePayload read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of ACEUpdatePayload given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ACEUpdatePayload
     * @throws IOException if the JSON string is invalid with respect to ACEUpdatePayload
     */
    public static ACEUpdatePayload fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ACEUpdatePayload.class);
    }

    /**
     * Convert an instance of ACEUpdatePayload to an JSON string
     *
     * @return JSON string
     */
