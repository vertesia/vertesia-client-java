...
public class SuccessResponse {
    ...
    public SuccessResponse success(@jakarta.annotation.Nonnull Boolean success) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SuccessResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in SuccessResponse is not found in the empty JSON string",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SuccessResponse>() {
                        @Override
                        public void write(JsonWriter out, SuccessResponse value)
                                throws IOException {
