...
public class WorkflowRule {
    ...
    public WorkflowRule addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public WorkflowRule putMatchItem(String key, Object matchItem) {
        if (this.match == null) {
    ...
    public WorkflowRule putConfigItem(String key, Object configItem) {
        if (this.config == null) {
    ...
    public WorkflowRule eventSubscriptionMigrationStatus(
    ...
    public WorkflowRule eventSubscriptionMigrationError(
     ...
     * @return the WorkflowRule instance itself
     */
    public WorkflowRule putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, workflowRule.id)
                ...
                && Objects.equals(this.updatedBy, workflowRule.updatedBy)
                && Objects.equals(this.createdBy, workflowRule.createdBy)
                && Objects.equals(this.createdAt, workflowRule.createdAt)
                && Objects.equals(this.updatedAt, workflowRule.updatedAt)
                && Objects.equals(this.endpoint, workflowRule.endpoint)
                && Objects.equals(this.inputType, workflowRule.inputType)
                && Objects.equals(this.match, workflowRule.match)
                && Objects.equals(this.config, workflowRule.config)
                && Objects.equals(this.debug, workflowRule.debug)
                && Objects.equals(this.customerOverride, workflowRule.customerOverride)
                && Objects.equals(this.taskQueue, workflowRule.taskQueue)
                && Objects.equals(
                        this.eventSubscriptionMigrationStatus,
                        workflowRule.eventSubscriptionMigrationStatus)
                && Objects.equals(
                        this.eventSubscriptionMigrationError,
                        workflowRule.eventSubscriptionMigrationError)
                && Objects.equals(this.additionalProperties, workflowRule.additionalProperties);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to WorkflowRule
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WorkflowRule.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in WorkflowRule is not found in the empty JSON string",
                                WorkflowRule.openapiRequiredFields.toString()));
            }
        }

        // check to make sure all required properties/fields are present in the JSON string
        for (String requiredField : WorkflowRule.openapiRequiredFields) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WorkflowRule.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WorkflowRule' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<WorkflowRule> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(WorkflowRule.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<WorkflowRule>() {
                        @Override
                        public void write(JsonWriter out, WorkflowRule value) throws IOException {
                        ...
                        @Override
                        public WorkflowRule read(JsonReader in) throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            WorkflowRule instance = thisAdapter.fromJsonTree(jsonObj);
    ...
    /**
     * Create an instance of WorkflowRule given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of WorkflowRule
     * @throws IOException if the JSON string is invalid with respect to WorkflowRule
     */
    public static WorkflowRule fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, WorkflowRule.class);
    }

    /**
     * Convert an instance of WorkflowRule to an JSON string
     *
     * @return JSON string
     */
