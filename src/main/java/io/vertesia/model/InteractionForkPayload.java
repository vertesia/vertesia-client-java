...
public class InteractionForkPayload {
     ...
     * @throws IOException if the JSON Element is invalid with respect to InteractionForkPayload
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InteractionForkPayload.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                java.util.Locale.ROOT,
                                "The required field(s) %s in InteractionForkPayload is not found in the empty JSON string",
                                InteractionForkPayload.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!InteractionForkPayload.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'InteractionForkPayload' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<InteractionForkPayload> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(InteractionForkPayload.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<InteractionForkPayload>() {
                        @Override
                        public void write(JsonWriter out, InteractionForkPayload value)
                                throws IOException {
                        ...
                        @Override
                        public InteractionForkPayload read(JsonReader in) throws IOException {
    ...
    /**
     * Create an instance of InteractionForkPayload given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of InteractionForkPayload
     * @throws IOException if the JSON string is invalid with respect to InteractionForkPayload
     */
    public static InteractionForkPayload fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, InteractionForkPayload.class);
    }

    /**
     * Convert an instance of InteractionForkPayload to an JSON string
     *
     * @return JSON string
     */
