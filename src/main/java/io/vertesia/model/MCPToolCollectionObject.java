...
public class MCPToolCollectionObject {
    ...
    public static final String SERIALIZED_NAME_API_KEY_CONFIG = "api_key_config";

    @SerializedName(SERIALIZED_NAME_API_KEY_CONFIG)
    @jakarta.annotation.Nullable private MCPApiKeyConfig apiKeyConfig;
    ...
    public MCPToolCollectionObject apiKeyConfig(
            @jakarta.annotation.Nullable MCPApiKeyConfig apiKeyConfig) {
     ...
     * @return apiKeyConfig
     */
    @jakarta.annotation.Nullable public MCPApiKeyConfig getApiKeyConfig() {
        return apiKeyConfig;
    }

    public void setApiKeyConfig(@jakarta.annotation.Nullable MCPApiKeyConfig apiKeyConfig) {
        this.apiKeyConfig = apiKeyConfig;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.url, mcPToolCollectionObject.url)
                ...
                && Objects.equals(this.apiKeyConfig, mcPToolCollectionObject.apiKeyConfig)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the optional field `api_key_config`
        if (jsonObj.get("api_key_config") != null && !jsonObj.get("api_key_config").isJsonNull()) {
            MCPApiKeyConfig.validateJsonElement(jsonObj.get("api_key_config"));
        }
