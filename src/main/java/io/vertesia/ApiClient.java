...
import io.vertesia.auth.ApiKeyAuth;
import io.vertesia.auth.Authentication;
import io.vertesia.auth.HttpBasicAuth;
import io.vertesia.auth.HttpBearerAuth;
import io.vertesia.auth.OAuth;
import io.vertesia.auth.OAuthFlow;
import io.vertesia.auth.RetryingOAuth;
import java.io.File;
...
public class ApiClient {
    ...
    protected String basePath = "https://api.us1.vertesia.io/api/v1";
    protected List<ServerConfiguration> servers =
            new ArrayList<ServerConfiguration>(
                    Arrays.asList(
                            new ServerConfiguration(
                                    "https://api.{region}.vertesia.io/api/v1",
                                    "Vertesia API",
                                    new HashMap<String, ServerVariable>() {
                                        {
                                            put(
                                                    "region",
                                                    new ServerVariable(
                                                            "Regional API host label. `us1` is the global endpoint.",
                                                            "us1",
                                                            new HashSet<String>(
                                                                    Arrays.asList(
                                                                            "us1", "eu1", "jp1"))));
    ...
    public ApiClient(
        ...
        String tokenUrl = "https://sts.vertesia.io/oauth/token";
        ...
        RetryingOAuth retryingOAuth =
                new RetryingOAuth(
                        tokenUrl, clientId, OAuthFlow.ACCESS_CODE, clientSecret, parameters);
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.us1.vertesia.io/api/v1)
     ...
     * @return a {@link io.vertesia.ApiClient} object
     */
     ...
     * @throws io.vertesia.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.vertesia.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.vertesia.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.vertesia.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.vertesia.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.vertesia.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.vertesia.ApiException If fails to update the parameters
     */
     ...
     * @throws io.vertesia.ApiException If fail to serialize the request body object into a string
     */
