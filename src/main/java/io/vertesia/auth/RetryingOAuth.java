...
public class RetryingOAuth extends OAuth implements Interceptor {
    ...
    private Response retryingIntercept(
            Chain chain, boolean updateTokenAndRetryOnAuthorizationFailure) throws IOException {
        Request request = chain.request();

        // If the request already has an authorization (e.g. Basic auth), proceed with the request
        // as is
        ...
        if (getAccessToken() != null) {
            ...
            // 401/403 response codes most likely indicate an expired access token, unless it
